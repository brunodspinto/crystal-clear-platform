...
| Step 7         | ...validating all data (global validation — no duplicate name + type)? (AC3)                             | OrganizationRepository          | **Information Expert**: the repository holds all Organization instances and is the natural place to check for duplicates.                        |
...
| Step 8         | ...informing operation success?                                                                          | RegisterOrganizationUI          | **Information Expert**: the UI is responsible for user interactions.                                                                             |
