...
>
> **Answer:** The `nature` field indicates the legal nature of the organization. It is not the same as the formal type — it complements it with information about whether the organization is of a public, private, or social character. To avoid invalid entries, it must be selected from a predefined list of natures (Public, Private, Social).
...
* **AC4:** The organization nature must be selected from the predefined list: Public, Private, or Social.
...
* Selected data:
    ...
    * organization nature (from predefined list: Public, Private, Social)
