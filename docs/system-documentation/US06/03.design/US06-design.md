...
| Step 3         | ...creating each PositionEntry with its nature, grossSalary, sideIncomeConsulting, sideIncomeBoardMemberships, startDate, endDate, organization and function? (AC3, AC4) | Declaration                     | **Creator** + **Information Expert**: a Declaration aggregates its PositionEntry instances; it is responsible for creating and owning them.                                        |
